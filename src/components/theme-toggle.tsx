...
export function ThemeToggle() {
  ...
  return (
    <button
      type="button"
      onClick={toggleTheme}
      className="inline-flex h-9 items-center gap-2 rounded-lg border border-line bg-surface px-3 text-sm font-medium text-ink-2 shadow-sm transition-colors hover:bg-inset hover:text-ink active:scale-95 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-accent"
    ...
    >
      {isDark ? (
        <svg
          ...
          aria-hidden="true"
          viewBox="0 0 24 24"
          className="icon-pop size-4 fill-none stroke-current stroke-[1.8]"
        >
